...
public class PdfVO {
	...
	private PdfInnerVO innerObject; //内部属性对象

	private List<PdfInnerVO> testList;

	private String codeCd;//测试代码值
	...
	public PdfInnerVO getInnerObject() {
		return innerObject;
	}

	public void setInnerObject(PdfInnerVO innerObject) {
		this.innerObject = innerObject;
	}

	public List<PdfInnerVO> getTestList() {
		return testList;
	}

	public void setTestList(List<PdfInnerVO> testList) {
