...
//
//		//1 取得文档模板
//		DocumentMeta template = NohiDocService.getDocumentByDocId(doc.getDocId());
//		if (null == template) {
...
//	}
//
//	public Object importFromInputStream(DocVO doc, InputStream is, boolean parseFieldValueErrorExit) throws Exception {
